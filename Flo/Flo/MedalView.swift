...
//  Flo
//
//  Created by chenzhipeng on 15/2/23.
...
class MedalView: UIImageView {
    ...
    func createMedalImage() -> UIImage {
        ...
        //Add Shadow
        let shadow:UIColor = UIColor.blackColor()
        ...
        CGContextDrawLinearGradient(context, gradient, CGPointMake(40, 40), CGPointMake(100, 162), 0)
